...
!  ----------------------------------------------------------------------------
!  Log-likelihood
REAL FUNCTION Bearded2__lglk(pars)
...
!  unpack
!  Helper for unpack
REAL FUNCTION Bearded2__next_param()
...
!  unpack
!  Helper for unpack
REAL FUNCTION BEARDED2__NEXT_PARAM_CB()
  ...
  val = temp_pars(nextpari)
  nextpari = nextpari + 1
  BEARDED2__NEXT_PARAM_CB = val
  RETURN 
  
ENDFUNCTION BEARDED2__NEXT_PARAM_CB
...
!  ----------------------------------------------------------------------------
!  Log-likelihood
SUBROUTINE BEARDED2__LGLK_BPARS(pars,parsb1_pars,lglkb1_pars)
...
ENDSUBROUTINE BEARDED2__LGLK_BPARS
...
ENDSUBROUTINE BEARDED2__CALC_PROBS_BPARS
  ...
  DO i6 = 1,ad_count5
    ...
    DO i5 = 1,ad_count4
      ...
      DO i4 = 1,ad_count3
        ...
        &) survb1_pars = survb1_pars + iage * surv**(iage - 1) * s_yijb&
        &1_pars(y,i,j)
...
ENDSUBROUTINE BEARDED2__POPULATE_BPARS
...
ENDSUBROUTINE BEARDED2__UNPACK_BPARS
...
!  unpack
!  Helper for unpack
SUBROUTINE BEARDED2__NEXT_PARAM_BPARS(next_paramb1_pars)
...
ENDSUBROUTINE BEARDED2__NEXT_PARAM_BPARS
...
ENDSUBROUTINE BEARDED2__UNPACK_CB

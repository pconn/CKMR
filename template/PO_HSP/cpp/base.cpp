// Basic CKMR template for 2-sex POPs and HSPs with perfect genotyping, known ages, and knife-edge maturity
...
#include "$(short-classname)_constructor_arrays_phase_1.hpp"
	...
	// eg  #include "$(short-classname)_constructor_arrays_phase_2.hpp"
...
void $(classname)::make_data_summaries()
{
